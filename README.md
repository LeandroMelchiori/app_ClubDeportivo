...
- [ ] **Gestión de múltiples administradores** — Sistema de roles con alta, edición y baja de usuarios del staff (la pantalla de Configuración ya tiene los botones estructurados, pendientes de implementación).
...
Desarrollado como proyecto universitario por:
   - Leandro Melchiori
   - Carlos Zarate
   - Javier Navarro
   - Heber Choque
